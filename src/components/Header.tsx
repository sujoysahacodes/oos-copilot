...
export function Header() {
  ...
  const { alerts, changeRequests } = useDistributionOOSStore();
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Distribution OOS Copilot</h1>
              <p className="text-sm text-gray-600">AI-Powered Supply Chain Intelligence</p>
            </div>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
            <span className="text-sm text-green-600 font-medium">AI Engine Active</span>
          </div>
        </div>
        ...
        <div className="flex-1 max-w-md mx-8">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search distributors, requests, or products..."
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            {pendingRequests > 0 && (
              <div className="absolute -bottom-1 -right-1 bg-yellow-500 text-white text-xs rounded-full h-4 w-4 flex items-center justify-center">
                {pendingRequests}
              </div>
            )}
          </div>
